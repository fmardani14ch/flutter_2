...
class ARAYESH extends StatefulWidget {
  @override
  State<ARAYESH> createState() => _ARAYESHState();
}

var mail = mail_mode;
TextEditingController user_id_controler = TextEditingController();

class _ARAYESHState extends State<ARAYESH> {
  @override
  void initState() {
        ...
        bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                  icon: Icon(Icons.shopping_basket_outlined), label: "محصولات"),
              BottomNavigationBarItem(
